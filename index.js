...
var listMotCle = ["poils", "kadoc", "volette", "assassin", "tard", "roulettes", "raison", "héro", "ah c'est ça", "crame mecs", "c'est nous", "alternative", "boire", "bite", "miches", "fôret", "je sais pas", "parler", "arthur", "fromage", "ave", "chance", "bataille", "manger", "dinde", "bohort", "révolte", "cassez", "pédagogie", "bucher", "au bucher", "bucher !", "burgonde", "comprend", "change", "discussion", "vite", "vomis", "glander", "bien fait", "c'est de la merde", "histoire", "dur", "honteux", "glandus", "ambiance", "flèches", "faux", "faux", "rigolo", "sinécure", "filiforme", "prodigieux", "blague", "reste", "les autres", "picole", "charmant", "marteau", "chier", "comment", "bèche", "boules", "crame", "cramer", "cuillère", "cuillère arthur", "nord", "vêtement", "trou du cul", "tirez vous", "tocard", "écarte", "poulette", "pute", "mignone", "enquille", "épique", "pigeon", "barrer", "permis", "merde", "encore", "quelqu'un", "exagerer", "faut", "ferme", "à la zob", "féderer", "ta gueule", "à poil", "unijambiste", "fleur", "pomme", "fort en pomme", "notice", "fulgurant", "cul", "c'est ça", "porcelet", "connais pas", "beau", "code", "pue", "tatan", "pisser", "insipide", "interprète", "comaque", "pas chez moi", "enlever", "tronches", "paysan", "cherche", "entendu", "perdu", "graines", "poney", "battre", "capital", "cons", "plein air", "je vois", "bretagne", "trouble", "dit fort", "vivre", "vous dire", "vous faut", "raclette", "confiance", "bouffe", "carbure", "gerbe", "monstruosité", "caisse", "idiote", "à l'air", "pigeons", "graal", "gras", "pognon", "poisson", "qui l'ouvre", "canard", "femme", "parole", "fiolle", "discutailler", "pas possible", "sont pour rien", "important", "emmerde", "foutre", "dingue", "tout à fait", "développer", "forme", "mécréant", "mécréant !", "merci", "météo", "beurre", "ours", "gonzesse", "armure", "toujours dit", "toujours dit que", "écoute", "école", "mordu", "taisez vous", "pusso", "vacherie", "marre", "vache", "défis", "gros", "fort", "plaisante", "alcool", "galette", "lapin", "son nom", "conne", "indépendant", "corne", "diagonale", "sang", "plait-il", "politique", "détail", "vent", "pourquoi pas", "et pourquoi pas", "gueule", "connerie", "pucelle", "grouille", "fort ce con", "raide", "savoir pourquoi", "fâche", "quequette", "que ceci", "quies", "ranger", "slibard", "crêpe", "carer", "déconner", "charrette", "scorpion", "faisant", "vendeur", "attache", "du cul", "gros cul", "glands", "crêpes", "flan", "pequenauds", "très bien", "la ferme", "quart d'heure", "cake", "fion", "execution", "foutre la merde", "pro", "merdique", "admettez", "mouilles", "déconnez", "con", "crache", "utilisez", "rigole", "nuque", "tarlouze", "impressionnant", "mortel", "zut"]
